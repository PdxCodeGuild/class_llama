...
ones_digit = {0: '', 1: 'One', 2: 'Two', 3: 'Three', 4: 'Four',
              5: 'Five', 6: 'Six', 7: 'Seven', 8: 'Eight', 9: 'Nine',}
teen_digit = {0: '', 1: 'Eleven', 2: 'Twelve', 3: 'Thirteen', 4: 'Fourteen',
...
def num_to_phrase(num):
    ...
    if hund >= 0 and tens == 0:
        if ones == 0:
            return hund_digit[int(hund)] + "" + tens_digit[int(tens)] + "" + ones_digit[int(ones)]
        else:
            return hund_digit[int(hund)] + "" + tens_digit[int(tens)] + " and " + ones_digit[int(ones)]
    elif hund >= 1 and tens >= 1:
        return hund_digit[int(hund)] + " and " + tens_digit[int(tens)] + '-' + ones_digit[int(ones)]
    else:
        print("You did not enter a number in the range 100-999")
...
def main():
    ...
    num_input = input("Enter a number between 100-999: ")
