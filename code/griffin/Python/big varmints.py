#All sprites used are from "freepik" on flaticon.com
...
background = pygame.image.load("grass-nature.png")
...
def main():
    ...
    varmint_list = []
    for i in range(120):
        varm = Varmint(r.randint(40,1560),r.randint(40,920))
        varmint_list.append(varm)
    
    plant_list = []
    for i in range(60):
        plant = Grass(r.randint(40,920),r.randint(40,920))
        plant_list.append(plant)    

    predator_list = []
    for i in range(40):
        pred = Predator(r.randint(40,1560),r.randint(40,920))
    ...
    while running:
        ...
        for n in range(1):
            plant = Grass(r.randint(40,1560),r.randint(40,920))
            plant_list.append(plant)
